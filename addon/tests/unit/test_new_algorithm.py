...
from brain import get_circadian_lighting, calculate_dimming_step
...
class TestSimplifiedCircadianLighting:
    """Test the simplified circadian lighting curves."""

    def test_circadian_lighting_throughout_day(self, test_config, test_location):
        """Test circadian lighting values at different times of day."""
...
class TestMirrorParameters:
    ...
    def test_mirror_up_flag(self, test_location):
        ...
        result_mirrored = get_circadian_lighting(
        ...
        result_unmirrored = get_circadian_lighting(
            current_time=morning,
